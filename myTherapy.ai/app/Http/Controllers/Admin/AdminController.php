...
use App\Models\Admin\Service\AdminService;
...
{
    public function login(LoginValidation $validation, AdminService $service, AdminRepository $repository, EncryptionService $encryptionService)
    {
