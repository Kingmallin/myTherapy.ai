...
namespace DoctrineProxies\__CG__\App\Models\Meme;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class MemeImage extends \App\Models\Meme\MemeImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Meme\\MemeImage' . "\0" . 'id', '' . "\0" . 'App\\Models\\Meme\\MemeImage' . "\0" . 'mentalHealth', '' . "\0" . 'App\\Models\\Meme\\MemeImage' . "\0" . 'name', '' . "\0" . 'App\\Models\\Meme\\MemeImage' . "\0" . 'altText', '' . "\0" . 'App\\Models\\Meme\\MemeImage' . "\0" . 'fileLocation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MemeImage $proxy) {
    ...
    public function getFileLocation(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFileLocation', []);
    ...
    public function setFileLocation(string $fileLocation): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFileLocation', [$fileLocation]);

        parent::setFileLocation($fileLocation);
    }
